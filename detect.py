...
binary_image.save("link to in.png file(high resolution)") #taking the first frame of the feed, from the broadcasting side.
...
if __name__ == "__main__":
    ...
    cv2.imwrite("link to out.png file", im)
